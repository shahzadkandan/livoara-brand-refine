# LIVOARA Shopify Theme

Upload `livoara-shopify-theme.zip` in Shopify Admin → Online Store → Themes → Add theme → Upload zip file.
...
This package uses the approved clean LIVOARA organise, routine, and travel films. The earlier RADA-watermarked clips are not included.
